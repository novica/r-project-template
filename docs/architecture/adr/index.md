...
| [ADR-007: Add ry static checker and track latest tool versions](007-add-ry-static-checker.md) | 🟢 Accepted | Add ry for type/scope checking; run air, jarl and ry at their latest versions via local system hooks |
