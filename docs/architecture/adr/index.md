...
| [ADR-003: Manage R dependencies with rv](003-manage-r-dependencies-with-rv.md) | 🟢 Accepted | Use rv, not renv/packrat, for declarative R dependency management |
| [ADR-004: Unify docs into a single Quarto website](004-unify-docs-into-single-quarto-website.md) | 🟢 Accepted | Combine README, architecture/ADR markdown, and quartify-generated API reference into one Quarto website |
